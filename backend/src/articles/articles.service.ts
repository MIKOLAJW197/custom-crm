...
export class ArticlesService {
    ...
    async findOne(id: string, options?: FindOneOptions<Article>): Promise<Article | NotFoundException> {
    ...
    async create(createArticleDto: CreateArticleDTO, author: User): Promise<Article> {
        const newArticle = this.articleRepository.create({ ...createArticleDto, author });
        return this.articleRepository.save(newArticle);
    }

    async update(id: string, updateArticleDto: UpdateArticleDTO): Promise<Article | NotFoundException> {
